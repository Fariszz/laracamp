...
<section class="pricing">
    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-gila">
                            ...
                            <p>
                                <a href={{ route('welcome') }} class="btn btn-master btn-primary w-100 mt-3">
                                    Take This Plan
                                </a>
                            </p>
                        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-biasa">
                            ...
                            <p>
                                <a href={{ route('welcome') }} class="btn btn-master btn-secondary w-100 mt-3">
        ...
        <div class="row pb-70">
            <div class="col-lg-12 col-12 text-center">
                <img src={{ asset('/images/brands.png" ') }}eight="30" alt="">
            </div>
        </div>
    </div>
</section>
